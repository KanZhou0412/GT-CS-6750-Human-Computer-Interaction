# GT-CS-6750-Human-Computer-Interaction

This repository is organized to help complete **Milestone B** for a Human-Computer Interaction project.

## What is in this repo

- `milestone-b/README.md`: Milestone B overview and execution workflow
- `milestone-b/checklist.md`: Task checklist you can mark off as you complete work
...
1. Open `milestone-b/checklist.md` and set dates/owners.
...
See `milestone-b/README.md` for a practical 7-day finish plan.
